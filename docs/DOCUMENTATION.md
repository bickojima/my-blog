...
| 1.53 | 2026-09-09 | FR-29追加。個人用Gmailアプリの最小限の紹介・プライバシーポリシー、QA、実操作E2Eを追加。staging先行 |
...
| FR-29 | 個人用アプリ案内: ログイン不要の最小限の紹介とGmailプライバシーポリシーを同一ドメインに公開し相互リンクする | `src/pages/playwright-home/`, `src/layouts/AppInfo.astro` | ブログ記事・CMSナビとは別。確認項目はQA記録 |
...
| FR-29 | 個人用アプリ案内・データ取扱い表示 | E2E app-info | E-46: 2ページ×3デバイス | 実クリック・Enter・axe | 検証中 |
