/**
 * 包括的E2Eエビデンス取得スクリプト（2026-09-23 release: staging → main）
 ...
 * 使用方法:
 *   1. npm run build
 *   2. node evidence/2026-09-23/release-main/verify-comprehensive.mjs
 */
...
const EVIDENCE_DIR = join(process.cwd(), 'evidence', TODAY, 'release-main');
...
<p>日付: ${TODAY} | ブランチ: release/staging-to-main-2026-09-23（main 値のビルド。CMS モックのみ branch: staging に一時置換） | デバイス: PC / iPad Pro 11 / iPhone 14</p>
